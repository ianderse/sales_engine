...
class InvoiceTest < Minitest::Test
	...
	def test_it_returns_created_at
		assert_equal DateHandler.new("2012-03-25 14:54:09 UTC").to_date, invoice.created_at
	end

	def test_it_returns_updated_at
		assert_equal DateHandler.new("2012-03-25 14:54:09 UTC").to_date, invoice.updated_at
	end
end
